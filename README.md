...
* 第二步，登陆/新建github账号，回到本项目页面，点击右上角fork本项目的代码到你自己的账号，然后你账号下会出现一个一模一样的项目，接下来的操作均在你的这个项目下进行。（看不到图片/图裂请科学上网）【防止删库，图片已备份（https://github.com/ZinngRui/ImageHosting）】
  ![image]://github.com/wangziyingwen/ImageHosting/blob/master/AutoApi/fork.png)
